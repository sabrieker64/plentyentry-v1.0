...
export function fromAjax(init) {
  return new Observable(function (destination) {
    ...
    var withCredentials = config.withCredentials, xsrfCookieName = config.xsrfCookieName,
    ...
    {
      var progressSubscriber_1 = init.progressSubscriber, _c = init.includeDownloadProgress,
        includeDownloadProgress = _c === void 0 ? false : _c, _d = init.includeUploadProgress,
